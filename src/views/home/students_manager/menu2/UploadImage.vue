<template>
  <el-card class="user-form-card" shadow="hover">
    ...
    <el-form :model="newUser" :rules="rules" ref="newUserForm" label-width="100px">
      <el-form-item label="姓名" prop="name" class="newUser_input">
        <el-input v-model="newUser.name"></el-input>
      </el-form-item>
      <el-form-item label="学号" prop="id" class="newUser_input">
        <el-input v-model="newUser.id" disabled></el-input>
      </el-form-item>
      <el-form-item label="专业" prop="department" class="newUser_input">
        <el-input v-model="newUser.department"></el-input>
      </el-form-item>
      <el-form-item label="宿舍号" prop="dormid" class="newUser_input">
        <el-input v-model="newUser.dormid"></el-input>
      </el-form-item>
      <el-form-item label="人脸照片" prop="photoFile" class="newUser_input">
